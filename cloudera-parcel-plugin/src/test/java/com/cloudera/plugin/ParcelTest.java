...
public class ParcelTest {
  ...
  public void testGetOsDescriptor() {
    ...
    Assert.assertEquals("el6", Parcel.getOsDescriptor("LSB Version:    :base-4.0-amd64:base-4.0-noarch:core-4.0-amd64:core-4.0-noarch" +
    ...
    Assert.assertEquals("el7", Parcel.getOsDescriptor("LSB Version:\t:core-4.1-amd64:core-4.1-noarch\n" +
      "Distributor ID:\tCentOS\n" +
    ...
    Assert.assertEquals("trusty", Parcel.getOsDescriptor("No LSB modules are available.\n" +
    ...
    System.setProperty("os.name", "Linux");
    System.setProperty("os.version", "4.2.0-27-generic");
    Assert.assertEquals("xenial", Parcel.getOsDescriptor("No LSB modules are available.\n" +
      "Distributor ID: Ubuntu\n" +
